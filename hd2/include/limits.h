...
#define  SHRT_MIN    (short)(-32768L)	/* min value of short		*/
#define  USHRT_MAX	      65535	/* max value of unsigned short	*/
#define  INT_MAX	      32767	/* max value of int		*/
#define  INT_MIN       (int)(-32768L)	/* min value of int		*/
#define  UINT_MAX	      65535	/* max value of unsigned int	*/
#define  LONG_MAX	 2147483647L	/* max value of long		*/
#define  LONG_MIN	-2147483648L	/* min value of long		*/
#define  ULONG_MAX	 4294967295L	/* max value of unsigned long	*/
